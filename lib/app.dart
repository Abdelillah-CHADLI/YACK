      ...
      builder: (context, box, _) {
        return MaterialApp(
          ...
          routes: {
            ...
            '/init-account': (context) => themedRoute(
              context,
              const InitAccountScreen(),
              transparent: true,
            ),
            '/decrypt-account': (context) => themedRoute(
              context,
              const DecryptAccountScreen(),
              transparent: true,
            ),
            ...
            '/contract/view': (context) {
              ...
              return themedRoute(
                context,
                ContractAgreement(contractId: contractId),
              );
            },
            '/settings': (context) =>
            ...
            '/subscription': (context) => themedRoute(
              context,
